...
public interface ISystemUtil extends IBaseDAO<Object, Long> {
	 ...
	 * @return
	 */
	public abstract SysPositions findSysPositionsByUId(Long UId) throws MyException;
	 ...
	 * @return
	 */
	public abstract LoginUser findLoginUserByUId(Long UId) throws MyException;
	 ...
	 * @return
	 */
	public abstract SysEmployee findSysEmployeeByUId(Long UId) throws MyException;
	 ...
	 * @return
	 */
	public abstract Boolean checkPermissionsByUIdAndDlId(String UId, Long dlId) throws MyException;
}